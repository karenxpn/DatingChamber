...
struct AppPreviewModel {
    ...
    static let userModel = UserModel(id: "yo1NBb8aLlPbC1wJE5pdeJ4fZC92", name: "Karen", birthday: Date(), avatar: Credentials.img_url, bio: "Some bio here", images: [Credentials.img_url], interests: ["fuck", "you", "smth", "coffee", "tea", "chill", "travel"], gender: "Male")
}
